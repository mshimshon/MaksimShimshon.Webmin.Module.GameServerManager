...
namespace GameServerManager.Dashboard.Features.Lifecycle.Applcation.Queries.Handlers;
...
public class GetServerStatusHandler : IRequestHandler<GetServerStatusQuery, ServerInfoEntity?>
{
    ...
    public GetServerStatusHandler(ILifecycleServices lifecycleServices, IDispatcher dispatcher)
    {
